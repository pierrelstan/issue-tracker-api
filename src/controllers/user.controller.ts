...
const tokenExpiration = process.env.NODE_ENV === "development" ? "1d" : "3d";
...
export const logout = async (req: Request, res: Response) => {
    res.clearCookie(tokenName, cookieOptions).send({
...
/*
 * @description ription    Genrate a token based on user id
 */
